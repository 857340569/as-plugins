...
/**
 * 这是修改的可以悬浮的下拉刷新上拉加载PullToRefreshListView
 * <br/>这里面的类是使用第三方的类
 * @author calex_feng in 
 * <company><b>口袋理财</b></company>
 *
 */
public class PullToRefreshPinnedSectionListView extends PullToRefreshAdapterViewBase<ListView> {
	...
	protected void handleStyledAttributes(TypedArray a) {
		...
		if (mListViewExtrasEnabled) {
			...
			//-- 我添加的
			if(lv != null)
				lv.setFooterFramelayout(mLvFooterLoadingFrame);
	...
	@TargetApi(9)
	final class InternalPinnedListViewSDK9 extends PinnedSectionListView {

		public InternalPinnedListViewSDK9(Context context, AttributeSet attrs) {
			super(context, attrs);
		}
