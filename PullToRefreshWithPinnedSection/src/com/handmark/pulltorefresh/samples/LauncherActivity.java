...
public class LauncherActivity extends ListActivity {
	...
	public static final String[] options = { "PinnedListView", "ListView", "ExpandableListView", "GridView", "WebView", "ScrollView",
	...
	protected void onListItemClick(ListView l, View v, int position, long id) {
		...
		switch (position - 1) {
			default:
			case -1:
				intent = new Intent(this, PullToRefreshPinnedListActivity.class);
				break;
			case 0:
